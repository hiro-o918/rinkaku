...
//! signature text; `#[cfg(test)]` / `#[test]` test detection; and the
//! Rust end-to-end path via `parse_unified_diff` + `language_for_path`.
//! Reference-name collection is pinned in `rust_references.rs`.
