...
See [`docs/github-action.md`](docs/github-action.md) for how to use it
from another repository: a minimal workflow snippet, the full inputs/
outputs reference, and the trust-boundary considerations around which
rinkaku binary the action runs.
